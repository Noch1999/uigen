...
export class MockLanguageModel {
  ...
  private countToolMessages(prompt: any[]): number {
  ...
  private async *generateMockStream(
    ...
    if (toolMessageCount === 1) {
      ...
      yield { type: "tool-input-delta", id: "call_1", delta: toolArgs };
    ...
    if (toolMessageCount === 2) {
      ...
      yield { type: "tool-input-delta", id: "call_2", delta: toolArgs };
    ...
    if (toolMessageCount === 0) {
      ...
      yield { type: "tool-input-delta", id: "call_3", delta: toolArgs };
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        <Card title="Amazing Product" description="This is a fantastic product that will change your life."
